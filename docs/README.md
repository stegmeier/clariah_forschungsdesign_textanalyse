...
{% include image.html url="images/tundra_not_fraeulein_rottenmeier_query_and_result.png" description="Suchergebnisse für &quot;Nicht 'Fräulein' gefolgt von 'Rottenmeier'</span>." %}
